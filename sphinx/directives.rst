...
The :directive:`%Copying` directive is used to specify text included in any of
the module's generated files, typically copyright and licensing information.
...
This is a sub-directive of the :directive:`%CompositeModule`,
:directive:`%ConsolidatedModule` and :directive:`%Module` directives used to
specify some arbitrary text that will be included at the start of all source
files generated by SIP.  It is normally used to include copyright and licensing
terms.
