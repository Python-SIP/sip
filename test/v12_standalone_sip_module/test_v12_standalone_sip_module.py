...
cfg_package = 'v12_ns'
cfg_sip_module_configuration = ['BrokenTypeNames']


def test_wrapped_module_name(module):
    assert module.__name__ == 'v12_ns.v12_standalone_sip_module_module'

def test_toplevel_wrapped_types(module):
    assert module.Klass.__module__ == 'v12_ns.v12_standalone_sip_module_module'
    assert module.Klass.__name__ == 'Klass'
    assert module.Klass.__qualname__ == 'Klass'

def test_nested_wrapped_types(module):
    assert module.Klass.Nested.__module__ == 'v12_ns.v12_standalone_sip_module_module'
...
def test_sip_simplewrapper(module):
    from v12_ns.sip import simplewrapper, wrapper

    assert simplewrapper.__module__ == 'sip'
...
def test_sip_wrapper(module):
    from v12_ns.sip import wrapper

    assert wrapper.__module__ == 'sip'
    assert wrapper.__name__ == 'wrapper'
    assert wrapper.__qualname__ == 'wrapper'

def test_sip_wrappertype(module):
    from v12_ns.sip import wrappertype

    assert wrappertype.__module__ == 'sip'
